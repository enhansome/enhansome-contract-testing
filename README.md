...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,578 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [PACT Broker](https://github.com/pact-foundation/pact_broker) ⭐ 745 | 🐛 119 | 🌐 Ruby | 📅 2026-08-31 - Enables your consumer driven contracts workflow (<http://pact.dius.com.au/>).
...
* [PACT Node.js](https://github.com/pact-foundation/pact-node) ⭐ 152 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-31 - Node version of Pact, a Contract Testing Framework.
* [Specmatic Node.js](https://www.npmjs.com/package/specmatic) - Node wrapper of Specmatic.

## JavaScript

* [PACT JavaScript](https://github.com/pact-foundation/pact-js) ⭐ 1,808 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-31 - JS version of Pact. Pact is a contract testing framework for HTTP APIs and non-HTTP asynchronous messaging systems

## Java

* [KARATE](https://github.com/karatelabs/karate/tree/master/karate-netty#consumer-provider-example) ⭐ 8,932 | 🐛 9 | 🌐 Java | 📅 2026-08-31 - Testing framework. Allows execution of API Tests and API Test-Doubles, which makes it possible to implement consumer driven contracts in Java and other languages.
* [PACT JVM](https://github.com/pact-foundation/pact-jvm) ⭐ 1,141 | 🐛 379 | 🌐 Kotlin | 📅 2026-08-12 - JVM version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [PACT Go](https://github.com/pact-foundation/pact-go) ⭐ 951 | 🐛 49 | 🌐 Go | 📅 2026-08-30 - Golang version of Pact. Pact is a contract testing framework for HTTP APIs and non-HTTP asynchronous messaging systems.
...
* [Pact.js E2E](https://github.com/pact-foundation/pact-js/tree/master/examples/e2e) ⭐ 1,808 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-31 - The Pact.js repository has an End-to-End example that is made up of a Consumer, Provider and the Pact Broker for sharing and validating the contracts.
...
* [Specmatic Labs](https://github.com/specmatic/labs) ⭐ 1 | 🐛 4 | 🌐 Python | 📅 2026-08-22 - Contains all the Labs used during the Specmatic hands-on Workshop.
