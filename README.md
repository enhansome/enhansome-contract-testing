...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,093 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [PACT JavaScript](https://github.com/pact-foundation/pact-js) ⭐ 1,798 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-11 - JS version of Pact. Pact is a contract testing framework for HTTP APIs and non-HTTP asynchronous messaging systems

## Java

* [KARATE](https://github.com/karatelabs/karate/tree/master/karate-netty#consumer-provider-example) ⭐ 8,920 | 🐛 16 | 🌐 Java | 📅 2026-08-13 - Testing framework. Allows execution of API Tests and API Test-Doubles, which makes it possible to implement consumer driven contracts in Java and other languages.
...
* [PACT PHP](https://github.com/pact-foundation/pact-php) ⭐ 302 | 🐛 13 | 🌐 PHP | 📅 2026-08-11 - PHP version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [PACT Python](https://github.com/pact-foundation/pact-python) ⭐ 677 | 🐛 17 | 🌐 Python | 📅 2026-08-13 - Python version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [PACT Net](https://github.com/pact-foundation/pact-net) ⭐ 930 | 🐛 39 | 🌐 C# | 📅 2026-08-10 - C# version of Pact. Pact is a contract testing framework for HTTP APIs and non-HTTP asynchronous messaging systems.
...
* [Pact.js E2E](https://github.com/pact-foundation/pact-js/tree/master/examples/e2e) ⭐ 1,798 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-11 - The Pact.js repository has an End-to-End example that is made up of a Consumer, Provider and the Pact Broker for sharing and validating the contracts.
