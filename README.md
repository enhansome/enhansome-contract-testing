...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,647 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [PACT JavaScript](https://github.com/pact-foundation/pact-js) ⭐ 1,816 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-19 - JS version of Pact. Pact is a contract testing framework for HTTP APIs and non-HTTP asynchronous messaging systems

## Java

* [KARATE](https://github.com/karatelabs/karate/tree/master/karate-netty#consumer-provider-example) ⭐ 8,958 | 🐛 15 | 🌐 Java | 📅 2026-09-19 - Testing framework. Allows execution of API Tests and API Test-Doubles, which makes it possible to implement consumer driven contracts in Java and other languages.
* [PACT JVM](https://github.com/pact-foundation/pact-jvm) ⭐ 1,144 | 🐛 379 | 🌐 Kotlin | 📅 2026-09-15 - JVM version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [PACT Ruby](https://github.com/pact-foundation/pact-ruby) ⭐ 2,191 | 🐛 3 | 🌐 Ruby | 📅 2026-09-18 - Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [Pact.js E2E](https://github.com/pact-foundation/pact-js/tree/master/examples/e2e) ⭐ 1,816 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-19 - The Pact.js repository has an End-to-End example that is made up of a Consumer, Provider and the Pact Broker for sharing and validating the contracts.
